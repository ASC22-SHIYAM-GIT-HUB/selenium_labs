...
public class fun {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            firstName.clear();
            firstName.sendKeys("Shiyam");
            System.out.println("Entered First Name: Shiyam");
 
            // Enter Last Name
            WebElement lastName = driver.findElement(By.id("input-lastname"));
            lastName.clear();
            lastName.sendKeys("Raj");
            System.out.println("Entered Last Name: Raj");
 
            // Enter Email (unique)
            WebElement email = driver.findElement(By.id("input-email"));
            email.clear();
            email.sendKeys("Shiyamraj" + System.currentTimeMillis() + "@mail.com");
